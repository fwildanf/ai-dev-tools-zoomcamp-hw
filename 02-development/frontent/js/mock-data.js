/** Current-season snapshot used only while the backend is mocked. */
...
export const MOCK_SCOREBOARD = {
  ...
  matches: [
    {
      id: "mw4-1",
      utcKickoff: "2026-09-12T11:30:00Z",
      status: "FINISHED",
      home: "Liverpool",
      away: "Burnley",
      homeScore: 3,
    ...
    {
      id: "mw4-2",
      utcKickoff: "2026-09-12T14:00:00Z",
      status: "FINISHED",
      home: "Arsenal",
    ...
    {
      id: "mw4-4",
      utcKickoff: "2026-09-12T16:30:00Z",
      status: "FINISHED",
      home: "Chelsea",
      away: "Brentford",
      homeScore: 2,
    ...
    {
      id: "mw4-5",
      utcKickoff: "2026-09-13T13:00:00Z",
      status: "FINISHED",
      home: "Everton",
      away: "Aston Villa",
      homeScore: 1,
    ...
    {
      id: "mw4-6",
      utcKickoff: "2026-09-13T15:30:00Z",
      status: "SCHEDULED",
    ...
    {
      id: "mw4-7",
      utcKickoff: "2026-09-13T18:00:00Z",
      status: "SCHEDULED",
    ...
    {
      id: "mw4-8",
      utcKickoff: "2026-09-14T13:00:00Z",
      status: "SCHEDULED",
      home: "Fulham",
      away: "Leeds United",
      homeScore: null,
    ...
    {
      id: "mw4-9",
      utcKickoff: "2026-09-14T15:30:00Z",
      status: "SCHEDULED",
    ...
    {
      id: "mw4-10",
      utcKickoff: "2026-09-14T18:00:00Z",
      status: "SCHEDULED",
