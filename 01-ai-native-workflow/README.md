...
Local Django web app for managing shared household chores. It supports up to five household members, recurring chores, automatic assignment rotation, completion history, overdue labels, and workload filtering.
...
- [Django backlog](_docs/backlog.md)
